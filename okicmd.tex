...
Possible size options are \cs{big}, \cs{Big}, \cs{bigg}, and \cs{Bigg}.
...
\begin{center}
  \begin{tabular}{lcl} \toprule
    ...
    \cs{pprn}\Marg{\cs{cdot}}                & $\pprn{\cdot}$       & \code{\cs{mleft}(\cs{mleft}(\cs{cdot}\cs{mright})\cs{mright})}                         \\
    \cs{ccurl}\Marg{\cs{cdot}}               & $\ccurl{\cdot}$      & \code{\cs{mleft}\cs{}\{\cs{mleft}\cs{}\{\cs{cdot}\cs{mright}\cs{}\}\cs{mright}\cs{}\}} \\
    \cs{ssqbr}\Marg{\cs{cdot}}               & $\ssqbr{\cdot}$      & \code{\cs{mleft}\lbrack\cs{mleft}\lbrack\cs{cdot}\cs{mright}\rbrack\cs{mright}\rbrack} \\
    \cs{aagbr}\Marg{\cs{cdot}}               & $\aagbr{\cdot}$      & \begin{tabular}[l]{@{}l@{}}\cs{mleft}\cs{langle}\cs{mleft}\cs{langle}\\\code{ \cs{cdot}\cs{mright}\cs{rangle}\cs{mright}\cs{rangle}}\end{tabular} \\
    \bottomrule
  \end{tabular}
\end{center}
...
\begin{center}
  \begin{tabular}{lcl} \toprule
    ...
    \cs{norm}\Marg{x}                         & $\norm{x}$                   & \code{\cs{mleft}\cs{}|x\cs{mright}\cs{}|} \\
